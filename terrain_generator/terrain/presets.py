...
def playground_scene(seed: int = 7) -> ArenaScene:
    ...
    terrain = TerrainConfig(
        # 28.3 x 17.0 m is approximately twice the original 20 x 12 m area.
        kind="flat", rows=256, cols=448, length=28.3, width=17.0,
    ...
    elements = [
        ...
        TerrainElement("hollow_stairs", x=0.0, y=5.0, name="hollow_stairs", params={
            "length": 3.2, "width": 2.4, "height": 0.8, "steps": 8, "thickness": 0.05,
        }),
        # Keep the ramp clear of the stairs and the slalom lane below.
        TerrainElement("ramp", x=6.5, y=5.0, name="ramp", params={
        ...
        TerrainElement("tire_ring", x=4.5, y=-5.0, name="tire_rings", params={
            "count": 3, "spacing": 0.85, "major_radius": 0.27, "minor_radius": 0.10,
            "upright": False,
        }),
        # Move obstacle 8 away from both the ramp and the high wall.
        TerrainElement("slalom_poles", x=10.0, y=2.0, name="slalom_poles", params={
            "count": 6, "spacing": 0.8, "radius": 0.07, "height": 1.2, "zigzag": 0.32,
        }),
        TerrainElement("sandpit", x=9.5, y=-5.0, name="sandpit", params={
        ...
        TerrainElement("high_wall", x=12.0, y=0.0, name="high_wall", params={
